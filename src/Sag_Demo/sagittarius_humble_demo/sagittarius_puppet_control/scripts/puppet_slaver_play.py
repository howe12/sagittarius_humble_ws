...
from sagittarius_common_msgs.msg import ArmRadControl,JointSingleCommand
...
class RosbagToArmControl(Node):
    def __init__(self):
        ...
        # self.publisher = self.create_publisher(JointSingleCommand, 'commands/joint_single', 10)
